...
## Simple... But also **intuitive**
When designing this language, we always try to make each design choice as intuitive and easy to reason about as possible. You shouldn't need to memorize complicated rules or consult pages of documentation to accomplish common tasks — Elo prefers consistent, obvious behavior so you can build confidently and quickly.
