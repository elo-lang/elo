...
This series of documents is meant to be a brainstorming whiteboard, any information in these documents are not certain.

Design documentation is not meant to be any kind of final specification of release documentation. This is the temporary specification of Elo's design
characteristics and systems for what we plan in the moment for the language.
...
1. [`amm.md`](./amm.md): Specifies the memory management system we named **AMM** (stands for Assisted Memory Management) that will be implemented in this language and is supposed to be its main selling point.
