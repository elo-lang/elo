...
very related to this language's purpose as a tool. A strong and reliable piece
...
## History and goals
I'm creating this language with my friend Igor Ferreira for more than a year now
...
and/or contributing to it, it's safe consider it as a practically abandoned project (for now).
