...
impl Generator {
    pub fn choose_type(&self, t: &cir::Typing) -> String {
        return match t {
            cir::Typing::Primitive(cir::Primitive::I128) => "__int128".to_string(),
            ...
            cir::Typing::Primitive(cir::Primitive::U128) => "unsigned __int128".to_string(),
        ...
        match expr {
            ...
            cir::Expression::UnaryOperation { operator, operand } => {
                ...
                match *operator {
                    ...
                    cir::UnaryOperation::BNot => c::unop(op, c::Unop::BNot),
                    cir::UnaryOperation::Not => c::unop(op, c::Unop::Not),
                    cir::UnaryOperation::Addr => c::unop(op, c::Unop::Addr),
            ...
            cir::Expression::BinaryOperation {
                ...
                match *operator {
                    cir::BinaryOperation::Add => c::binop(lhs, rhs, c::Binop::Add),
                    cir::BinaryOperation::Sub => c::binop(lhs, rhs, c::Binop::Sub),
                    cir::BinaryOperation::Mul => c::binop(lhs, rhs, c::Binop::Mul),
                    cir::BinaryOperation::Div => c::binop(lhs, rhs, c::Binop::Div),
                    cir::BinaryOperation::Lt => c::binop(lhs, rhs, c::Binop::Lt),
                    cir::BinaryOperation::Gt => c::binop(lhs, rhs, c::Binop::Gt),
                    cir::BinaryOperation::Le => c::binop(lhs, rhs, c::Binop::Le),
                    cir::BinaryOperation::Ge => c::binop(lhs, rhs, c::Binop::Ge),
                    cir::BinaryOperation::Eq => c::binop(lhs, rhs, c::Binop::Eq),
                    cir::BinaryOperation::Ne => c::binop(lhs, rhs, c::Binop::Ne),
                    cir::BinaryOperation::Assign => c::binop(lhs, rhs, c::Binop::Assign),
                    c => {
                        dbg!(c);
                        todo!()
                    }
    ...
    pub fn generate_statement(&mut self, stmt: &mut cir::Statement) -> String {
        ...
        match stmt {
            ...
            cir::Statement::FnStatement(stmt) => {
            ...
            cir::Statement::ExternFnStatement(stmt) => {
            ...
            cir::Statement::StructStatement(stmt) => {
                let fields = stmt
                    .fields
                    .iter()
            ...
            cir::Statement::EnumStatement(stmt) => {
            ...
            cir::Statement::ExpressionStatement(expr) => {
                let e = self.generate_expression(&expr);
                output.push_str(&e);
            }
            cir::Statement::ReturnStatement { value, typing: _ } => {
