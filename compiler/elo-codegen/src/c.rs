...
impl std::fmt::Display for Binop {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        match self {
            ...
            Binop::AssignAdd => write!(f, "+="),
            Binop::AssignSub => write!(f, "-="),
            Binop::AssignMul => write!(f, "*="),
            Binop::AssignDiv => write!(f, "/="),
            Binop::AssignMod => write!(f, "%="),
            Binop::AssignBAnd => write!(f, "&="),
            Binop::AssignBOr => write!(f, "|="),
            Binop::AssignBXor => write!(f, "^="),
            Binop::BAnd => write!(f, "&"),
            Binop::BOr => write!(f, "|"),
            Binop::BXor => write!(f, "^"),
